...
if ( ! Qform::checkToken() ) : ?>
	<div class="wrap">
		<div style="margin-top:20px;">
			<?php
			echo strip_tags( __( '<p>To evaluate app capability and activation,<br/> discover the token of the site to which it is linked.<a href="https://app.qform.io/"> Where to get a token?</a></p>',
				'qform' ),
				'<p><br /><a>' ) ?>
			<a href="<?php
...
<?php
	...
	<div class="wrap">
		...
		if ( ! $forms ) : ?>
			<?php
			echo strip_tags( __( '<p>Add a form in your account <a href="https://app.qform.io/">https://app.qform.io</a></p>',
				'qform' ),
				'<p><a>' ); ?>
		<?php
		else: ?>
